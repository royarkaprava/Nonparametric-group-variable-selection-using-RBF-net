...
#For Yte it is primarily the locations to be predicted are important, not the actual values at those places. One may set 1 at the locations to be predicted.
